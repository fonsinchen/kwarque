...
$.widget("mapQuery.mqPopup", {
    ...
    _onFeatureselected: function(evt, data) {
        ...
        element.html('<div class="mq-popup ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">'+
                '<span class="ui-dialog-title">' + self.options.title + '</span>'+
                '<a class="ui-dialog-titlebar-close ui-corner-all" href="#">'+
                '<span class="ui-icon ui-icon-closethick">close</span></a>'+
                '</div>' +
                '<div" class="ui-dialog-content ui-widget-content">' + contents + '</div>')
