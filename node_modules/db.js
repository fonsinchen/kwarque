...
var queries = {
    'getFragments'   : "SELECT id, x, y, title, text, owner FROM fragment WHERE x > $1 AND x < $3 AND y > $2 AND y < $4",
    'insertFragment' : "INSERT INTO fragment (x, y, title, text, owner) VALUES ($1, $2, $3, $4, $5) RETURNING id",
...
var ignore = function(client, fn) {
    for (var i = 0; i < client.watchedNodes.length - 1; ++i) {
        ...
        client.watchedNodes[i].clean(); // TODO: probably not enough
    }
